	...
	?>       
        ...
        <ul class="old_post">
        	<li>
                ...
                <ul class="comentu">
					<?php 
						$resultc = mysql_query("SELECT c.user_id, c.comment FROM blog_comment c WHERE post_id=".$row["id"]) or die(mysql_error());
               ...
               <form action="" method="post" name="comment">
               		...
               		<input type="hidden" name="post_id" value="1<?php echo $row['id'];?>" />
                    <input type="submit" ame="com_submit" value="Комментировать" class="" />
               </form>	
               </div>
               <?php }?>
            </li>
